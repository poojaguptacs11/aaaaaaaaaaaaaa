                ...
                <div class="col-lg-12 ">
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <h1><a href="<?php echo base_url('Titlename/view');?>">School Name</a><h1>
                        </div>
                        <div class="panel-body">
                        <div class="row show-grid">
                           
                                          
                             <form  action="<?php echo base_url();?>Titlename/save" role="form"  method="post">
                                <div class="col-md-offset-3 col-md-6 col-md-offset-3">
                                   
                                    <div class="form-group">
                                            <label>School Name</label>
                                            <input class="form-control" name="School Name">
                                        </div>
                                </div>
