...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> Title Tables</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                        ...
                                        <td><?php echo $user->Student_name?></td>
                                         <td><?php echo $user->Student_Id?></td>
                                          <td><?php echo $user->Password?></td>
                                           <td><?php echo $user->About_you?></td>
                                            <td><?php echo $user->Subject?></td>
                                        <td><a href="<?php echo base_url();?>register/edit/<?php echo $user->id;?>"><span class="glyphicon glyphicon-edit"> </span></a></td>
                                         <td><a href="<?php echo base_url();?>titletable/delete/<?php echo $user->id;?>"><span class="glyphicon glyphicon-trash"> </span></a></td>
