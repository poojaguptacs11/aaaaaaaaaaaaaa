    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Student update</h1>
                    </div>
                    <div>
                     <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <form role="form" action="<?php echo base_url('studentform/updatetable');?>" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="class">10th
                                            </label>
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="class">12th
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="teachers_name">
                                               ...
                                               <?php foreach ($listing as $key => $value): ?>
                                                <option value="<?php echo $key[1]; ?>"><?php echo $value->title; ?></option>
                                               <?php endforeach ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
