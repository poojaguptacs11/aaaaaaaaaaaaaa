                     ...
                     <h1 class="page-header"> Student Update</h1>
                        ...
                        <div class="row show-grid">
                           <?php foreach($data as $user){?>
                             ...
                             <form  action="<?php echo base_url('newpanel/update');?>" role="form"  method="post">
                            ...
                            <div class="col-md-offset-2 col-md-3 col-md-offset-2"">
                                    <div class="form-group">
                                            <label>City</label>
                                            <input class="form-control" name="City" value="<?php echo $user->City;?>">
                                        </div>
                                </div>
                                <div class="col-md-offset-2 col-md-3 col-md-offset-2"">
                                    ...
                                    <div class="form-group">
                                            <label>State</label>
                                            <input class="form-control" name="State" value="<?php echo $user->State;?>">
                                        </div>
                                </div>
                                <div class="col-md-offset-2 col-md-3 col-md-offset-2"">
                                    <div class="form-group">
                                            <label>Country</label>
                                            <input class="form-control" name="Country" value="<?php echo $user->Country;?>">
                                        </div>
                                </div>
                                <div class="col-md-offset-2 col-md-3 col-md-offset-2">
                                    ...
                                    <div class="form-group">
                                            <label>Zipcode</label>
                                            <input class="form-control" name="Zipcode" value="<?php echo $user->Zipcode;?>">
                                        </div>
                                         </div>
                                </div>
                              <div class="form-group">
