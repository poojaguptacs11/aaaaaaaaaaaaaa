...
<body>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url();?>">Panels and Wells</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>">Buttons</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>">Notifications</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>">Typography</a>
                                </li>
                                <li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover Context Classes" id="dataTables-example">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>student_name</th>
                                        <th>student_id</th>
                                        <th>about_your_detail</th>
                                        <th>class</th>
                                        <th>gender</th>
                                        <th>teachers_name</th>
                                        <th>all_subject</th>
                                ...
                                <tbody>
                                     <?php $k=1; foreach($data as $user){?>
                                    <tr class="odd gradeX">
                                        <td><?php echo $k++?></td>
                                        <td><?php echo $user->student_name?></td>
                                        <td><?php echo $user->student_id?></td>
                                        <td><?php echo $user->about_your_detail?></td>
                                        <td class="center"><?php echo $user->class?></td>
                                        <td class="center"><?php echo $user->gender?></td>
                                          <td><?php echo $user->teachers_name?></td>
                                            <td><?php echo $user->all_subject?></td>
                                            <td><a href="<?php echo base_url();?>studentform/edit/<?php echo $user->id;?>"><span class="glyphicon glyphicon-edit"> </span></a></td>
                                         <td><a href="<?php echo base_url();?>studentform/delete/<?php echo $user->id;?>"><span class="glyphicon glyphicon-trash"> </span></a></td>
    ...
    <script src="<?php echo base_url();?>admin/vendor/datatables-plugins/dataTables.bootstrap.min.js"></script>
    <script src="<?php echo base_url();?>admin/vendor/datatables-responsive/dataTables.responsive.js"></script>
    <script>
