...
<head>
    ...
    <!-- DataTables CSS -->
    <link href="<?php echo base_url();?>admin/vendor/datatables-plugins/dataTables.bootstrap.css" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="<?php echo base_url();?>admin/vendor/datatables-responsive/dataTables.responsive.css" rel="stylesheet">
