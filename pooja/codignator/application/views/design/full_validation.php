...
<!-- <script>
	function validationform(myform)
	{
		...
		else if(myform.pincode.value=="")
		{
			alert('please enter your pincode!');
			myform.pincode.focus();
			return false;
		}
		else if(myform.email_id.value=="")
		{
			alert('please enter your email id!');
			myform.email_id.focus();
			return false;
		}
		else if(myform.gender.value=="" || myform.gender.value=="")
		{
			alert('please select your gender!');
			myform.gender.focus();
			return false;  
		}
		else if(myform.checkbox.value=="" ) 
		{
			alert('please check your  box!')
			myform.checkbox.focus();
			return false;
			
		}
		else if(myform.radio.value=="" ) 
		{
			alert('please select your  box!')
			myform.select.focus();
			return false;
...
<body bgcolor="pink">
	<fieldset>
		<center>
		<div>
	<form name="myform" action="<?php echo base_url();?>full_validationform/save" method="post" >
     <div>
     	<b>FirstName:<input type="text" name="firstname" id="firstname" class="" size="30"></b>
     </div><br>
     <div>
     ...
     <div>
     	<b>Email Id:<input type="text" name="email_id" id="email id" size="30"></b>
     </div> <br>
     	<div>
     		<b>Date of Birth:</b>	
     ...
     <b>Gander:</b><input type="radio" name="gender" value="male">Male
     	<input type="radio" name="gender" value="female">Female
     		...
     		<select name="teacher" id="teacher">
     			...
     			&
     		<b>Subject's Name:</b>	<select name="subject" id="subject">
     				<option>subjects</option>
     				<option value="Database">Database</option>
     				<option value="Autometa">Autometa</option>
     			<option value="webTech">webTech</option>
     			<option value="Enterpreneur">Enterpreneur</option>
     			<option value="Mathmatics1">Mathmatics1</option>
     			<option value="Mathmatics2">Mathmatics2</option>
     			<option value="Sofwaretesting">Sofwaretesting</option>
